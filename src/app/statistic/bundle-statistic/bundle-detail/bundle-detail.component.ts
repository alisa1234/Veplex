...
export class BundleDetailComponent {
  ...
  tittle_id:string;
    ...
    constructor(http:Http, domains:Domains, public router:Router,public route: ActivatedRoute, public popupChange:PopupChange, public filters:Filters, public initChosen:InitChosen, public calendarService:CalendarService,public renderStatistic:RenderStatistic, public globalLogin:GlobalLogin) {
        ...
        this.calendarService.name_class='bundle-detaile_calendar';
        this.calendarService.id='id_bundle-detaile_calendar';
        this.calendarService.id2='id2_bundle-detaile_calendar';
        ...
        if(this.route.snapshot.data['name']=='detailStatisticBundle') {
        ...
        this.renderStatistic.eventEmitters3.subscribe(list=>{
            this.list = list;
