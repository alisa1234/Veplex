...
export class DetailComponent implements OnInit {
  ...
  constructor(http:Http, domains:Domains, public router:Router,public route: ActivatedRoute, public popupChange:PopupChange, public filters:Filters, public initChosen:InitChosen, public calendarService:CalendarService,public renderStatistic:RenderStatistic, public globalLogin:GlobalLogin) {
    ...
    this.urlGetList = domains.urlGetOfferDetailStatistic;
      this.calendarService.name_class='statistic-detail_calendar';
      this.calendarService.id='id_statistic-detail_calendar';
      this.calendarService.id2='id2_statistic-detail_calendar';
    ...
    let result:any;
      ...
      this.checked['subid']=true;
      this.checked['subid2']=true;
      this.checked['subid3']=true;
      this.checked['subid4']=true;
      this.checked['countrie']=true;

      if(this.route.snapshot.data['name']=='detailStatistic') {
       
          this.route.snapshot.data['breadcrumb'] = 'Detailed Statistic ' + this.tittle_name;
      }
    ...
    this.renderStatistic.eventEmitters2.subscribe(list=>{
        this.list = list;
